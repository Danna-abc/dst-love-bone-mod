...
local Teleport = require("scripts/util/teleport")
local BondManager = require("scripts/manager/bondmanager")
...
USE_WANGSHENG.fn = function(act)
    if not GLOBAL.TheNet:GetIsServer() then return true end
    local user = act.doer
